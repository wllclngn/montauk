...
TEST(process_filter_case_insensitive_substring) {
  montauk::model::ProcessSnapshot ps{};
  ps.processes.push_back({.pid=10,.ppid=0,.utime=0,.stime=0,.total_time=0,.rss_kb=1000,.cpu_pct=2.0,.user_name="mod",.cmd="Firefox --new-tab",.exe_path="/usr/bin/firefox"});
  ps.processes.push_back({.pid=20,.ppid=0,.utime=0,.stime=0,.total_time=0,.rss_kb=2000,.cpu_pct=1.0,.user_name="mod",.cmd="code --unity-launch",.exe_path="/usr/bin/code"});
  ps.processes.push_back({.pid=30,.ppid=0,.utime=0,.stime=0,.total_time=0,.rss_kb=500,.cpu_pct=0.5,.user_name="root",.cmd="firefoxUpdater",.exe_path="/usr/bin/updater"});
