...
// Compile-time ASCII lowercase lookup table.
// Single array index per character -- no branching, no locale, no function call.
// A-Z (0x41-0x5A) map to a-z (0x61-0x7A). Everything else passes through.
inline constexpr unsigned char ascii_lower_table[256] = {
...
[[nodiscard]] inline constexpr unsigned char ascii_lower(unsigned char c) {
