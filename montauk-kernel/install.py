...
def main():
    ...
    if proc.returncode != 0:
        ...
        print()
        print("  NOTE: If you update your kernel, you must re-run this installer!")
        print("        The module is built for a specific kernel version.")
        print("        After a kernel update, run: ./install.py")
        print()
    ...
    print()
    print("IMPORTANT: After kernel updates, re-run this installer!")
